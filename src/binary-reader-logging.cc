...
DEFINE_INDEX(OnArrayNew)
DEFINE_INDEX(OnArrayGet)
DEFINE_INDEX(OnArraySet)
DEFINE_INDEX(OnArrayLen)
...
DEFINE_INDEX(OnStructNew)
DEFINE_INDEX_INDEX(OnStructGet, "type_index", "field_index")
DEFINE_INDEX_INDEX(OnStructSet, "type_index", "field_index")
